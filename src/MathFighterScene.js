...
export default class MathFighterScene extends Scene {
    ...
    init() {
      this.gameHalfWidth = this.scale.width * .5
      this.gameHalfHeight = this.scale.height * .5
    ...
    gameStart(){
      ...
      this.enemy.anims.play('player-standby',true)

      this.resultText = this.add.text(this.gameHalfWidth, 400, '0',{fontSize: '32px', fill: '#000'})
      this.questionText = this.add.text(this.gameHalfWidth, 400, '0',{fontSize: '32px', fill: '#000'})
